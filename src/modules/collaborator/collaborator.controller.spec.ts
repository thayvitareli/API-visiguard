...
describe('ColaboratorController', () => {
  ...
  let collaboratorServiceMock: CollaboratorService;
  ...
  beforeEach(async () => {
    ...
    collaboratorControler = module.get<ColaboratorController>(
      ColaboratorController,
    );
    collaboratorServiceMock =
      module.get<CollaboratorService>(CollaboratorService);
  });
  ...
  describe('create', () => {
    it('should create a collaborator', async () => {
      ...
      const result = await collaboratorControler.create(
        createCollaboratorDto,
        req,
      );
  ...
  describe('find all', () => {
    it('should return a list of collaborators and total', async () => {
      const result = await collaboratorControler.findAll({
        search: '',
        skip: 0,
        take: 2,
      });
